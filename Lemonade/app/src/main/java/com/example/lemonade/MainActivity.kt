            ...
            when(currentStep){
                1 -> {
                    LemonContent(
                        ...
                        descriptionId = R.string.lemon_tree_text,
                        onImageClick = {
                            currentStep = 2
                ...
                2 -> {
                    LemonContent(
                        ...
                        descriptionId = R.string.lemon_text,
                        onImageClick = {
                            squeezeCount--
                            if (squeezeCount == 0){
                                currentStep = 3
                ...
                3 -> {
                    LemonContent(
                        ...
                        descriptionId = R.string.glass_of_lemonade_text,
                        onImageClick = {
                            currentStep = 4
                        }
                    )
                ...
                4 -> {
                    LemonContent(
                        ...
                        descriptionId = R.string.empty_glass_text,
                        onImageClick = {
                            currentStep = 1
                        }
                    )
...
@Composable
fun LemonContent(textLabelId: Int, imageId: Int, descriptionId: Int, onImageClick: () -> Unit, modifier: Modifier = Modifier){
    Box(
        modifier = modifier
    ){
        Column (
